...
export default function Homepage({ currentUser, setCurrentUser }) {
  ...
  return (
    <div className="z-30 fixed overflow-y-auto flex flex-col md:flex-row h-screen w-screen bg-gradient-to-r from-indigo-900 to-blue-700">
      {/* 左邊 */}
      <div className="w-full md:w-1/4">
        <div className="h-screen flex flex-col py-4 px-2 md:p-6">
          {/* LOGO */}
          <div>
          ...
          <div className="md:hidden pt-10vh flex flex-col justify-end gap-40 w-full">
            <div className="flex-col items-start text-white box-border p-4">
